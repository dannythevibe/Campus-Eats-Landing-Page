            ...
            <div className="relative z-10 w-full max-w-md mx-4 overflow-hidden rounded-[2rem] border border-white/20 shadow-2xl backdrop-blur-xl bg-white/10">
                ...
                <div className="p-8 md:p-10 flex flex-col items-center">
                    ...
                    <div className="flex flex-col items-center mb-8">
                        ...
                        <h2 className="text-white text-xl font-bold">Log in to your account</h2>
                    ...
                    <form className="w-full space-y-5">
                        <div className="space-y-1">
                            ...
                            <input
                                type="email"
                                className="w-full px-4 py-3 rounded-xl bg-transparent border border-white/30 text-white placeholder:text-gray-400 focus:border-orange-500 focus:ring-1 focus:ring-orange-500 outline-none transition-all"
                            />
                        </div>
                        ...
                        <div className="text-center text-xs text-white">
                            Don't have an account? <a href="#" className="text-orange-400 font-bold hover:underline">Sign Up</a>
                        </div>
